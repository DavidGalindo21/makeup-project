  ...
  // Ajax Contact Form JS
    ...
    $(form).submit(function(e) {
      ...
      $.ajax({
        ...
        $(formMessages).addClass('alert alert-success mt-3 fade show');
        ...
        if (data.responseText === '') {
          ...
          $(formMessages).text('Tu mensaje ha sido enviado con éxito. Gracias por tu comentario.');
        }
      });
    });
...
function logoutUser() {
  Swal.fire({
      ...
      text: "¡Tu sesión se cerrará si confirmas!",
      icon: 'warning',
